...
#define AVX_RSQRT_FLOAT(X)               _mm256_rsqrt_ps(X)
...
#define AVX_RSQRT_FLOAT(X)               _mm256_div_pd(_mm256_set1_pd(1.), _mm256_sqrt_pd(X))
...
#define AVX_RECIPROCAL_FLOATS(X)         _mm256_div_pd(_mm256_set1_pd(1.), X)
